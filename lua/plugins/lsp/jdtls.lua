return {
	...
	config = function()
		-- local cfg = {
		-- 	cmd = { "jdtls" },
		-- 	root_dir = vim.fs.dirname(vim.fs.find({ "gradlew", ".git", "mvm" }, { upward = true })[1]),
		-- }
		...
		local path_to_plugins = vim.fn.stdpath("data") .. "\\mason\\packages\\jdtls\\"
		local path_to_jar = path_to_plugins .. "plugins\\org.eclipse.equinox.launcher_1.7.0.v20250331-1702.jar"
